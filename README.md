...
A scene with incomplete planning metadata can still discuss and continue its saved draft; missing context is reported without inventing canon. Full scene generation retains its required-context checks.
