...
export function CompositionComposer({ busy, canGenerate, draftLabel, sourceLabels, sourcePolicy, onGenerate }: { busy: boolean; canGenerate: boolean; draftLabel: string | null; sourceLabels: string[]; sourcePolicy: string; onGenerate: (input: CompositionInput) => void }) {
