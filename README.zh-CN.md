...
- 提供中文本地化的 React/Vite 作者工作台，可显示真实 API 项目树、空 workspace 引导、场景草稿、协作草稿箱、Context Pack 检查、连续性 QA、工作流事件查看、图/时间线预览、待审事实处理、本地 txt/md/docx 文件或文件夹导入、agent settings 管理和更新检查。
